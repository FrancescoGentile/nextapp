...
<template>
    ...
    <CustomEvents v-if="showEvents" :channelId="this.id" :isSubscribed="this.isSubscribed"></CustomEvents>
    <CustomNews v-if="showNews" :channelId="this.id" :isSubscribed="this.isSubscribed"></CustomNews>
</template>
