...
export interface ChannelRepository {
   ...
   * @param channel_id
   */
  is_president(user_id: UserID, channel_id: ChannelID): Promise<boolean>;
   ...
   * @param channel
   */
  update_channel(channel: Channel): Promise<boolean>;

  /**
   * Returns the channel with the given channel_name if it exists; null otherwise.
   * @param channel_name
   */
  get_channel_by_name(channel_name: string): Promise<Channel | null>;
}
