...
export interface SubRepository {
   ...
   * @param sub_id
   */
  get_subscription_info(sub_id: SubID): Promise<Sub | null>;
   ...
   * @param sub_id
   */
  delete_subscriber(user_id: UserID, sub_id: SubID): Promise<boolean>;
   ...
   * @param channel_id
   */
  get_club_subscribers(channel_id: ChannelID): Promise<Sub[]>;
   ...
   * @param channel_id
   */
  is_sub(user_id: UserID, channel_id: ChannelID): Promise<boolean>;
}
